// To convert a binary tree to Doubly linked list we have 3 methods:

// 1. Convert the binary tree to a doubly linked list using the inorder traversal.
// 2. Convert the binary tree to a doubly linked list using the preorder traversal.
// 3. Convert the binary tree to a doubly linked list using the postorder traversal.

// We will be using the inorder transversal in this following snippet
